...
\institute{Intistuto de Matemática}
...
\adviser{Profa. Dra. Tatiane Nogueira Rios}
...
% Ficha catalográfica
\authorcitationname{Carvalho, Nilton Vasques} % e.g. Terceiro, Antonio Soares de Azevedo
...
\catalogtopics{``1. Lógica Fuzzy. 2. Mineração de dados. 3. Organização de documentos.''} % e.g. ``1. Complexidade Estrutural. 2. Engenharia de Software''
